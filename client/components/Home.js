...
export const Home = ({ sanity }) => {
  return (
    <>
      ...
      <section className=" flex items-center justify-center h-[40vh] md:h-[60vh] mb-12 bg-fixed bg-center bg-cover bg-solutions-image ">
        <div className="-z-0 w-full h-[40vh] md:h-[60vh] bg-fixed bg-black bg-opacity-40 flex flex-col gap-5b justify-center items-center p-5 text-white">
          <p className="-z-10 p-5 text-center text-3xl md:text-5xl fixed top-1/2">
            Combined 100+ years of financial industry experience
          </p>
        </div>
      </section>
      <div className="my-40 z-20 relative">
        ...
        <p data-aos="fade-left" className=" p-10 md:px-[20vw] text-center text-md md:text-xl">
          Brand Loyalty must be earned and re-earned every day.Like fashion, what&aposs in style and
          hot today, may change tomorrow.Belliforum operates with a combined 100+ years of financial
          industry experience knowing that today&aposs best may not always be. We are not tied to
          any brand, institution, product, service, or firm. We are here to find the best of the
          best and adapt immediatly.
        </p>
      </div>
      <section className="z-10 relative flex items-center justify-center h-screen bg-fixed bg-center bg-cover bg-yacht-image">
        <div className="z-20 relative w-full h-screen bg-black bg-opacity-[55%] flex flex-col gap-5b justify-center items-center p-5 text-white">
          ...
          <p data-aos="fade-right" className="p-10 md:px-[20vw] text-center text-md md:text-xl">
            Because we&aposre all about amplifying fun! In plain English, we help you achieve what
            you want to do more rapidly and efficently! Whatever that vision is, we want to be a
            part of it with you and have fun together doing it. Our goal is to make your life
            better, to have more fun and do more of whatever it is that makes you want to get up in
            the morning.
          </p>
        </div>
      </section>
